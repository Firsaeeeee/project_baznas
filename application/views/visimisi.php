    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="beranda" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-success">
                ...
                <h6 class="text-success">BAZNAS PURWAKARTA</h6>
            </h2>
        </a>
        ...
        <div class="d-flex align-items-center mb-3">
            <div class="d-flex align-items-center justify-content-center flex-shrink-0" style="width: 20px; height: 20px;">
                <i class="far fa-envelope-open text-center"></i>
            </div>
            <div class="ms-3">
                ...
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        <a href="<?php echo base_url('visimisi') ?>" class="nav-item nav-link">
                            ...
                            <h5 class="text-bold mb-3">Visi & Misi</h5>
                    </div>
                </div>
                </a>
            </div>
                    ...
                    <div class="container">
                        <div class="row g-5">
                            <div class="text-center" data-wow-delay="0.3s">
                                <h4 class="section-title bg-white text-center text-success text-align">VISI BAZNAS </h4>
                                <h1 class="text-justify text-center text-center">Kabupaten Purwakarta</h1>
                                <p class=" text-center text-justify">“Menjadi Pengelola Zakat yang Unggul dan Terpercaya di Tingkat Provinsi”</p>
                                <a class="" href=""></a>
                                <img class="img-fluid" src="<?php echo base_url('assets') ?>/img/logobadnas.png" alt="">
                    ...
                    <div class="container">
                        <div class="row g-5">
                            <div class="text-center">
                                <h4 class="section-title bg-white text-success text-align">MISI BAZNAS </h4>
                                <h1 class="text-justify text-bold text-center">Kabupaten Purwakarta</h1>
                                <h4 class="text-justify text-success text-center">Misi Umum Baznas</h4>
                                <p style="text-align: justify;">Mengkoordinasikan pengelolaan zakat di tingkat Kabupaten untuk mencapai target-target Nasional Mengoptimalkan secara terukur penghimpunan zakat se-Kabupaten Purwakarta Mengoptimalkan pendistribusian dan pendayagunaan zakat untuk mengurangi angka kemiskinan, peningkatan kesejahteraan masyarakat, dan pemoderasian kesenjangan sosial Menerapkan sistem manajemen keuangan yang transparan dan akuntabel berbasis teknologi informasi dan komunikasi terkiniMenerapkan sistem pelayanan prima kepada seluruh pemangku kepentingan zakat Menggerakkan dakwah Islam dan mengkonsolidasikan seluruh elemen Ummat Islam untuk kebangkitan zakat Terlibat aktif dalam memimpin gerakan sadar zakat di tingkat Kabupaten purwakarta yang berdampak secara nasional Mengarus utamakan zakat sebagai instrumen pembangunan daerah menuju masyarakat yang adil, makmur, sejahtera dan ta’at beragama Mengembangkan kompetensi amil zakat yang unggul dan terpercaya serta menjadi rujukan di tingkat Nasional</p>
                                <a class="" href=""></a>
                            </div>
                            <div class="text-center">
                                <!-- <h4 class="section-title text-center bg-white text-success text-align">MISI KHUSUS BAZNAS</h4> -->
                                <!-- <h1 class="text-justify text-bold text-center">Kabupaten Purwakarta</h1> -->
                                <h4 class="text-justify text-success text-center">Misi Khusus Baznas</h4>
                                <p style="text-align: justify;">Menjadikan Baznas Kabupaten Purwakarta sebagai wahana aktualisasi sebagai seorang muslim yang mukhlis dan muhsiMenjadikan Baznas Kabupaten Purwakarta sebagai wahana untuk mengaktualisasikan diri menjadi muslim yang berkarakter nafi’un lighairihi (memberi manfaat untuk sesama)Memfasilitasi Kaum Muslimin dan diri sendiri dalam Membersihkan harta dan mensucikan jiwa Menjadikan Baznas Kabupaten Purwakarta sebagai media ibadah dan amal soleh untuk bekal mecapai ridla Allah dan bertemu dengan Allah Menjadikan Baznas Kabupaten Purwakarta sebagai media untuk memperkokoh ukhuwwah islamiyah dan hubungan silaturrahim</p>
                                <a class="" href=""></a>
                            </div>
                        </div>
                    </div>

...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse " id="navbarCollapse">
            ...
            <!-- <a href="" class="btn btn-success py-4 px-lg-5 d-none d-lg-block">LOGIN<i class="fa fa-arrow-right ms-3"></i></a> -->
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container py-8">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="text-center text-success text-bold">Lengkapi Data Di Bawah Ini </div>
                <form action="<?= base_url('zakat/bayar_zakat') ?>" method="post">
                    <!-- Nama Input -->
                    <div class="mb-3">
                        <label for="exampleInputNama" class="form-label">Nama</label>
                        <input name="nama" type="text" class="form-control" id="exampleInputNama" aria-describedby="namaHelp" required>
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputzakat" class="form-label">Zakat</label>
                        <select class="form-select" id="exampleInputzakat" aria-label="Default select example" required>
                            <option selected>Pilih Jenis Zakat</option>
                            <option value="zakat mall">Zakat Maal</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="nominal" type="number" class="form-control" id="exampleInputNominal" aria-describedby="nominalHelp" required>
                    </div>

                    <!-- Email Input -->
                    <div class="mb-3">
                        <label for="exampleInputEmail" class="form-label">Email</label>
                        <input name="email" type="email" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" required>
                    </div>

                    <!-- No HP Input -->
                    <div class="mb-3">
                        <label for="exampleInputNoHP" class="form-label">No HP</label>
                        <input name="no_hp" type="tel" class="form-control" id="exampleInputNoHP" aria-describedby="nohpHelp" required>
                    </div>

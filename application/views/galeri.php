        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h5 class="mb-5 text-warning text-bold">Kegiatan Pendistribusian 3000 Paket Beras</h5>
                </div>
                <div class="row g-4">
                    <?php
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item bg-light">
                                <div class="overflow-hidden">
                                    <img class="img-fluid" src="<?php echo base_url('assets/upload/gallery/') . $photo->image ?>" alt="">
                                </div>
                            </div>
                        </div>
                    <?php
